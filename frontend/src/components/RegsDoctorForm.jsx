...
import specialistField from "../Context_APIs/specialistFields";
  ...
  return (
    <div>
      <div className="card-container">
        {" "}
        {/*to customise Bootstrap classes i found it easier to wrap the class in a div and use scss to manipulate the divs' content */}
          ...
          <Form className="form-class">
            ...
            <Form.Group className="input-field" controlId="formBasicEmail">
              ...
              <Form.Control
                name="licenseNumber"
                type="text"
                placeholder="enter licence phone number"
                onChange={(e) => {
                  handleFormInput(e);
                }}
              />
            ...
            <Form.Group className="input-field" controlId="formBasicEmail">
              ...
              <DropdownButton
                ...
                title="Select practice field"
              >
                {specialistField.map((item) => {
