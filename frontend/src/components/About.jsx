          ...
          <div className="card">
            <div className="box">
              ...
              <p>
                ...
                enim eligendi perspiciatis distinctio fugiat inventore est cum
                omnis ipsum. Magni, possimus aspernatur. Architecto numquam ut
                accusantium aliquid asperiores error a?
              </p>
            </div>
          </div>
          <div className="card">
