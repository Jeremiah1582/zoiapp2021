const specialistFields = [
...

  {
    ...
    description: `Anesthesiology (anesthesia) is a diversified specialty where physicians are required to tactically merge their knowledge of physiology and pharmacy and use their technical skills to provide pain management, critical care, and perioperative care. To be able to excel in this specialty, one needs to have certain strengths such as the ability to perform under pressure, think quickly in stressful situations, and use your hands to work in a team environment. This specialty does not offer an opportunity to establish a long-term patient-physician relationship.To become certified in anesthesiology, you need to do 5 years of Royal College-approved residency training post completion of medical school. This involves 1 year of basic cynical training and 4 years of Royal College-approved training.`,
  },

  {
    field: "Cardiology",
    description: `Cardiology is one of the many medical doctor specialties where practitioners need to prove their mastery and competence. Cardiologists are expected to act as only consultants with respect to cardiovascular disease. As a cardiology specialist, you must be able to deal with all kinds of cardiovascular problems associated with hypertensive, rheumatic, and congenital heart disease and with cardiomyopathies.
  ...
  To become certified in critical care medicine, you must hold base specialty certification in anesthesia, medicine, emergency medicine or surgery, and certain surgical subspecialties such as neurosurgery and cardiac surgery.`,
  },

  {
    field: `Dermatology`,
    description: `Dermatology is a varied specialty that addresses benign and malignant disorders of the skin, mouth, external genitalia, hair, and nails, as well as a number of sexually transmitted diseases.
  ...
  Endocrinology and Metabolism is the branch of medical doctor specialties that focuses on the
  study of the diseases of the endocrine organs, disorders of hormone systems and their target organs, and metabolism disorders. The physician who specializes in this practice is able to assess, diagnose, and treat patients with diseases such as diabetes, menopause, hypertension, thyroid diseases, cholesterol diseases, and more.
...

  {
    ...
    description: `The general surgeon is trained to diagnose and provide care during preoperative, operative, and postoperative management of the patient. This includes having the knowledge of various surgical procedures including head, neck, pediatric, surgical critical care, surgical oncology, transplants, and more.
  To become a certified general surgeon, you must complete an additional 5 years of training in a Royal College-approved program after completing your medical school.
  `,
  },

  {
    field: "General/Clinical Pathology",
    description: `General pathology is a medical specialty that’s concerned with all aspects of laboratory investigation in health and disease. This involves understanding the causes, manifestations, and diagnosis of a disease. A pathologist generally acts as a consultant for clinical physicians and advises them on the possible treatment of patients. Pathologists apply a range of biomedical science knowledge to achieve a diagnosis
  ...
  },
  {
    ...
    description: `The key role of the medical biochemist is to study and measure the biochemical abnormalities in human diseases. The field demands the candidate to possess technology-driven specialties. A certified medical biochemist is trained in the operation and management of hospital biochemistry laboratories and acts as an active consultant in all facets of their use.
  ...
  {
    field: "Nephrology",
    description: `Nephrology is a medical subspecialty of internal medicine where specialists diagnose and
  ...
  {
    field: "Neurosurgery",
    description: `Neurosurgery includes dealing with diseases of the skull, the brain, the pituitary, and the spinal cord. This discipline emerged as a result of a rising need for special expertise in the surgical and non-surgical treatment of different diseases that affect the nervous system and its supporting structures. The field of neurosurgery focuses on the central, peripheral, and autonomic nervous systems. Practitioners diagnose problems with the help of tools such as MRI, CT scans, and laboratory tests.
...

  {
    ...
    description: `Obstetrics/gynecology is a doctor specialty that incorporates medical, surgical, and obstetrical and gynecologic competency and skills for the prevention, diagnosis, and management of a wide variety of conditions affecting women’s general and reproductive health. This is a combination of two specialties:
...

  {
    ...
    description: `Otolaryngology is one of the slightly different doctor specialties that is primarily concerned with the screening, diagnosis, and treatment of medical and surgical disorders of the ear, the upper respiratory and upper alimentary systems, and related structures of the head and neck. Certified otolaryngologists must possess a thorough knowledge of the general principles of medicine and surgery.
  ...
  {
    field: "Pediatrics",
    description: `Pediatrics is a field of doctor specialty that focuses on the physical, emotional, and social health of neonates, infants, children, adolescents, and young adults. This field of medicine is concerned with health promotion, prevention, detection, and treatment of physical, behavioral, mental/emotional, environmental, and social issues that affect children.
  ...
  {
    field: "Public Health and Preventive Medicine (PhPm)",
    description: `Public health and Preventive medicine is the field of medicine that places emphasis on the overall good health of the population.
  ...
  {
    field: "Respirology",
    description: `Respiratory medicine, also known as respirology, is a medical subspecialty of internal medicine that focuses on the diagnosis and treatment of diseases that are associated with the respiratory system. This field of medicine is strongly rooted in physiology.
  ...
  {
    field: "Rheumatology",
    description: `Rheumatology is primarily focused on the diagnosis and treatment of rheumatic diseases, which may involve multiple systems, as well as joint, muscle, and skeletal disorders.
  ...
  {
    field: "Urology",
    description: `Urology is a surgical subspecialty that concentrates on the medical and surgical treatment of disorders and diseases associated with the female urinary tract and the male urogenital system. The most common clinical issues that come up involve prostate disease, renal dysfunction particular to surgical management (colic, stones), bladder dysfunction, and urinary tract infections.
